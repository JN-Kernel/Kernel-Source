				...
				$.post("user/getUsername.do",function(data,stauts){
					if(stauts == "success"){
						...
						$("#userinfo").html('<a href="user_info.html">'
								...
								+'</a>'
								+'<ul class="sub-menu">'
								+'<li><a href="user_info.html"><i class="glyphicon glyphicon-user"></i> 我的信息</a></li>'
								+'<li><a href="user_publish.html"><i class="glyphicon glyphicon-pencil"></i> 发表主题</a></li>'
								+'<li><a href="user.html"><i class="glyphicon glyphicon-cloud"></i> 已发表文章</a></li>'
								+'<li class="divider"></li>'
